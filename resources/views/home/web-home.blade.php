@extends("master")
@section('title')Charity | Teamplate @endsection
@section("body")
    <main>
        <!-- slider Area Start-->
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="{{asset('web-assets')}}/assets/img/gallery/about2.png" alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="{{asset('web-assets')}}/assets/img/gallery/about1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Our Cases End -->
        <!-- Featured_job_start -->
        <section class="featured-job-area section-padding30 section-bg2" data-background="{{asset('web-assets')}}/assets/img/gallery/section_bg03.png">
            <div class="container">
                <div class="row justify-content-center">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('web-assets')}}/assets/img/gallery/team1.png" alt="">
                                <!-- Blog Social -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('web-assets')}}/assets/img/gallery/team2.png" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('web-assets')}}/assets/img/gallery/team3.png" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('web-assets')}}/assets/img/gallery/team4.png" alt="">
                                <!-- Blog Social -->
                                <ul class="team-social">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
        ...
        <section class="wantToWork-area ">
            <div class="container">
                <div class="wants-wrapper w-padding2  section-bg" data-background="{{asset('web-assets')}}/assets/img/gallery/section_bg01.png">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder">
                                        <div class="founder-img mb-40">
                                            <img src="{{asset('web-assets')}}/assets/img/gallery/testimonial.png" alt="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{asset('web-assets')}}/assets/img/gallery/home-blog1.png" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{asset('web-assets')}}/assets/img/gallery/home-blog2.png" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
        ...
        <!-- Blog Area End -->
        <!--? Count Down Start -->
        <div class="count-down-area pt-25 section-bg" data-background="{{asset('web-assets')}}/assets/img/gallery/section_bg02.png">
            <div class="container">
                <div class="row justify-content-center">
